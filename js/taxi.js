	...
	dataDetailsCont.innerHTML = `
        		<div class="booking-car-sect">
					...
					<div class="taxi-car-select">
						<div class="taxi-container js-car-container-0">
							<div class="taxi-sel-img">
								<img src="./images/car1.jpg" alt="" />
							</div>
							<div class="taxi-name-select">
								<p>Mercedes-Benz E220</p>
								<div class="taxi-select-btn taxi-select-btn-selected">
									SELECT
								...
								<div class="taxi-more-details">
									...
									<div class="taxi-car-make">
										...
										<ul class="breakdown-list">
											...
											<li class="break_down">
												<p>Extras</p>
												<p>Alloy Wheels, Bluetooth, Radio</p>
											</li>
										</ul>
									</div>
								</div>
								<div class="taxi-group">
									<div class="taxi-more-btn" data-car-more-info="0">
